...
var
	ax,bx,cx,dx,si,tmp,x1a2,res,i,inter,cfc,cfd,compte,j,l,k: Word;
	x1a0  : array[0..7] of Word;
	cle   : array[0..15] of char;
	cry: array[0..33000] of char;
        newkey : string;

procedure Crypt(ThisCle, Buffer: PChar; BufferLength: Integer); export;
Procedure Decrypt(ThisCle, Buffer: PChar; BufferLength: Integer); export;
